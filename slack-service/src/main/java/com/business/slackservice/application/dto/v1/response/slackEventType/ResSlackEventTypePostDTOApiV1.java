...
@Builder
public class ResSlackEventTypePostDTOApiV1 {
    @JsonProperty
    private SlackEventType slackEventType;

    public static ResSlackEventTypePostDTOApiV1 of(SlackEventTypeEntity slackEventTypeEntity) {
        return ResSlackEventTypePostDTOApiV1.builder()
