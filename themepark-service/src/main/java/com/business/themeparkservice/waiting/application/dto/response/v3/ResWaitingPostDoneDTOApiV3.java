...
@AllArgsConstructor
@NoArgsConstructor
public class ResWaitingPostDoneDTOApiV3 {
    private Waiting waiting;

    public static ResWaitingPostDoneDTOApiV3 of(WaitingEntity waitingEntity) {
        return ResWaitingPostDoneDTOApiV3.builder()
