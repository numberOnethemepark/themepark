...
import com.business.slackservice.application.service.v1.SlackTemplateServiceApiV1;
...
public class SlackTemplateControllerApiV1 {
    ...
    public ResponseEntity<ResDTO<ResSlackTemplateGetDTOApiV1>> getBY(
        ...
        ResSlackTemplateGetDTOApiV1 response = slackTemplateServiceApiV1.getBy(predicate, pageable);
        return new ResponseEntity<>(
