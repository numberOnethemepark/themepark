...
@AllArgsConstructor
@NoArgsConstructor
public class ResWaitingPostDoneDTOApiV2 {
    private Waiting waiting;

    public static ResWaitingPostDoneDTOApiV2 of(WaitingEntity waitingEntity) {
        return ResWaitingPostDoneDTOApiV2.builder()
