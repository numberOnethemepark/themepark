...
public class RedisConfig {
    ...
    public RedisTemplate<String, ResProductGetByIdDTOApi> ProductredisTemplate(RedisConnectionFactory redisConnectionFactory) {
        // Redis 와 통신을 위한 template 설정과정 Key = String, Value = ResProductGetByIdDTOApi 객체를 사용
        RedisTemplate<String, ResProductGetByIdDTOApi> redisTemplate = new RedisTemplate<>();
