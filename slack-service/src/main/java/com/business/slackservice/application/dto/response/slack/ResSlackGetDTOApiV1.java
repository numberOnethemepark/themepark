package com.business.slackservice.application.dto.response.slack;
...
@Builder
public class ResSlackGetDTOApiV1 {

    @JsonProperty
    private SlackPage slackPage;

    public static ResSlackGetDTOApiV1 of(Page<SlackEntity> slackEntityPage) {
        return ResSlackGetDTOApiV1.builder()
