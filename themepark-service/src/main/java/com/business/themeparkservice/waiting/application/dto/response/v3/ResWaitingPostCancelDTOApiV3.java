...
@NoArgsConstructor
@AllArgsConstructor
public class ResWaitingPostCancelDTOApiV3 {
    private Waiting waiting;

    public static ResWaitingPostCancelDTOApiV3 of(WaitingEntity waitingEntity) {
        return ResWaitingPostCancelDTOApiV3.builder()
