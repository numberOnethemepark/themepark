...
public class WaitingServiceImplApiV3 implements WaitingServiceApiV3 {
    ...
    @Transactional
    @Override
    public ResWaitingPostDTOApiV3 postBy(ReqWaitingPostDTOApiV3 reqDto, Long userId) {
...
//        WaitingChecking(reqDto,userId);
        ...
        try{
            ...
            return ResWaitingPostDTOApiV3.of(waitingEntity);
    ...
    @Override
    public ResWaitingGetByIdDTOApiV3 getBy(UUID id) {
        ...
        return ResWaitingGetByIdDTOApiV3.of(waitingEntity);
    }

    @Override
    public ResWaitingGetDTOApiV3 getBy(Predicate predicate, Pageable pageable) {
        Page<WaitingEntity> waitingEntityPage = waitingRepository.findAll(predicate,pageable);
        return ResWaitingGetDTOApiV3.of(waitingEntityPage);
    }

    @Override
    public ResWaitingPostDoneDTOApiV3 postDoneBy(UUID id) {
        WaitingEntity waitingEntity = findByIdAndStatus(id,WaitingStatus.WAITING);
        waitingEntity.postDone();
        return ResWaitingPostDoneDTOApiV3.of(waitingEntity);
    }

    @Override
    public ResWaitingPostCancelDTOApiV3 postCancelBy(UUID id) {
        WaitingEntity waitingEntity = findByIdAndStatus(id,WaitingStatus.WAITING);
        waitingEntity.postCancel();
        return ResWaitingPostCancelDTOApiV3.of(waitingEntity);
    }
